...
const { getUser, createUser, updateUser, deleteUser, getProfile, uploadAvatar, getContacts, toggleFavoriteUser, getFavoriteUsers } = require("../controllers/userController");
